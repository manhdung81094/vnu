...
namespace Common
{
    public static partial class myExtension
    {
        ...
        public static DataTable ConvertToDataTable<T>(this IEnumerable<T> data)
        {
            ...
            // Sắp xếp cột theo tên, không phân biệt hoa/thường
            var sortedColumns = table.Columns
                .Cast<DataColumn>()
                .OrderBy(col => col.ColumnName, Comparer<string>.Create((a, b) => string.Compare(a, b, StringComparison.OrdinalIgnoreCase)))
                .ToList();

            // Cập nhật lại thứ tự cột trong DataTable
            for (int i = 0; i < sortedColumns.Count; i++)
            {
                sortedColumns[i].SetOrdinal(i);
            }
